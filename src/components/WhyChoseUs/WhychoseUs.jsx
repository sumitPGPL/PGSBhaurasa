const WhychoseUs =( )=>{
    ...
    <section id="features"
        ...
        <div className="relative mx-auto max-w-7xl z-10 grid grid-cols-1 gap-10 pt-14 sm:grid-cols-2 lg:grid-cols-3 ">
            <div className="rounded-md border border-neutral-800 bg-neutral-900/50 p-8 text-center shadow transition duration-300 ease-in-out hover:scale-110">
                ...
                <h3 className="mt-6 text-gray-400">State-of-the-art Infrastructure</h3>
                <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide text-gray-400">Because your child deserves the best
                </p>
            </div>
            ...
            <div className="rounded-md border border-neutral-800 bg-neutral-900/50 p-8 text-center shadow transition duration-300 ease-in-out hover:scale-110">
                ...
                <h3 className="mt-6 text-gray-400">Never A Dull Day</h3>
                <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide text-gray-400">No Matter what your interests, you’ll find your niche at PGPL, otherwise we will create one together
                </p>
            </div>
            ...
            <div className="rounded-md border border-neutral-800 bg-neutral-900/50 p-8 text-center shadow transition duration-300 ease-in-out hover:scale-110">
                ...
                <h3 className="mt-6 text-gray-400">From ABC to AI</h3>
